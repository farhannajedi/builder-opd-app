                ...
                <div class="space-y-3 max-w-2xl">
                    ...
                    <p class="text-xs sm:text-sm text-slate-300 leading-relaxed">
                        Menampilkan kumpulan publikasi artikel dan rilis berita dalam topik <span
                            class="text-brand-500 font-bold">{{ $categoryData->title }}</span> dari {{ $opdName }}.
                    </p>
                </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                ...
                <div class="col-span-full bg-slate-50 border border-slate-200/80 p-12 text-center rounded-2xl">
                    <div class="flex flex-col items-center justify-center gap-3">
                        ...
                        <a href="{{ url('/berita') }}"
                            class="mt-2 inline-flex items-center gap-1.5 text-xs font-bold text-brand-600 hover:text-brand-700">
            ...
            <div class="pt-8 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-2">
                    <a href="{{ $news->previousPageUrl() }}"
                        class="{{ $news->onFirstPage() ? 'pointer-events-none opacity-40' : 'hover:bg-brand-500 hover:text-white' }} px-3.5 py-2 bg-slate-100 text-slate-700 rounded-xl font-bold text-xs flex items-center gap-1 transition-colors">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ $news->nextPageUrl() }}"
                        class="{{ $news->hasMorePages() ? 'hover:bg-brand-500 hover:text-white' : 'pointer-events-none opacity-40' }} px-3.5 py-2 bg-slate-100 text-slate-700 rounded-xl font-bold text-xs flex items-center gap-1 transition-colors">
