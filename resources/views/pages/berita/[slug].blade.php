...
<div class="bg-gray-50 min-h-screen py-10 md:py-16">
    <section class="max-w-screen-lg pt-0 px-1 mx-auto w-full">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-8 md:gap-12">
            ...
            <div class="lg:col-span-3 space-y-8">
                ...
                <div class="space-y-4">
                    ...
                    <div
                        class="flex flex-wrap items-center gap-4 text-slate-500 text-sm border-y border-slate-300 py-3">
                        ...
                        <span class="hidden md:block text-slate-500">|</span>
                        @if($berita->category)
                        <span class="hidden md:block text-slate-500">Kategori :</span>
                        <span
                            class="bg-orange-300 px-2 py-1 text-slate-500 rounded-lg text-xs font-bold">{{ $berita->category->title }}</span>
                        @endif
                    </div>
                </div>
                ...
                <div class="prose prose-slate max-w-none">
                    <p class="text-slate-700 leading-relaxed text-lg italic border-l-4 border-slate-200 pl-4">
                        {!! $berita->deskripsi ?: 'Tidak ada deskripsi untuk berita ini.' !!}
                    </p>
                </div>
            ...
            <div class="lg:col-span-2 space-y-9 sticky">
                <h3 class="text-xl rounded font-bold text-slate-800 border-l-4 border-orange-600 pl-4 mb-6">Berita
                    Terkait</h3>
