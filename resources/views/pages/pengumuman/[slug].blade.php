...
$otherAnnouncements = App\Models\announcement::where('opd_id', $announcement->opd_id)->where('id', '!=',
$announcement->id)->latest()->take(4)->get();
...
<section class="max-w-screen-lg px-4 mx-auto w-full py-12">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div class="lg:col-span-2 space-y-8">
            <div class="space-y-6">
                <div
                    class="inline-flex items-center gap-2 bg-orange-100 text-orange-700 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider">
                ...
                <div class="flex items-center gap-4 text-slate-500 text-sm border-y border-slate-300 py-4">
            ...
            <div class="rounded-2xl overflow-hidden shadow-xl shadow-blue-100 border border-slate-100">
                <img src="{{ $imagePath }}" alt="{{ $announcement->title }}" class="w-full h-auto object-cover">
            </div>
            @endif
            ...
            <div class="pt-5 border-t border-slate-300">
                <a href="{{ url('/') }}"
                    class="inline-flex items-center gap-3 bg-slate-100 text-slate-700 px-6 py-3 rounded-2xl font-bold hover:bg-orange-600 hover:text-white transition-all duration-300 group">
        ...
        <div class="space-y-8">
            <div class="bg-white rounded-3xl p-8 border border-slate-100 shadow-xl">
                ...
                <div class="space-y-6">
                    ...
                    <a href="{{ url('pengumuman/' . $item->slug) }}" class="group block space-y">
                        <div class="flex items-center gap-2">
                            <span
                                class="text-[10px] font-bold group-hover:text-orange-600 text-slate-800 uppercase">{{ $item->title }}</span>
                        </div>
