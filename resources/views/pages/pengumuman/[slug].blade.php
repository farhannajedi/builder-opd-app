...
<div class="bg-slate-50/60 min-h-screen py-10 md:py-16">
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav class="flex items-center gap-2 mb-8 text-xs font-semibold text-slate-500 overflow-x-auto pb-2">
            ...
            <a href="{{ url('/pengumuman') }}" class="hover:text-brand-600 transition-colors shrink-0">Pengumuman</a>
            <span class="text-slate-300">/</span>
            ...
            <article
                ...
                <div class="space-y-4">
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-2">
                            <div
                                class="w-7 h-7 rounded-full bg-brand-100 text-brand-600 flex items-center justify-center font-bold text-xs">
                                {{ substr($opdName, 0, 1) }}
                            </div>
                ...
                <div
                    ...
                    <a href="{{ url('/pengumuman') }}"
                        class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-slate-100 hover:bg-brand-500 hover:text-brand-100 text-slate-700 text-xs font-bold transition-all w-full sm:w-auto justify-center">
                ...
                <div class="bg-white rounded-3xl p-6 border border-slate-200/80 shadow-sm">
                    ...
                    <div class="space-y-4">
                        ...
                        <a href="{{ url('pengumuman/' . $item->slug) }}"
                            class="group block p-4 rounded-2xl border border-slate-100 bg-slate-50/50 hover:bg-white hover:border-brand-200 hover:shadow-md transition-all duration-300 space-y-2">

                            <span class="text-[10px] font-black text-brand-600 uppercase tracking-wider block">
