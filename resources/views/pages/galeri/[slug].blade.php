                ...
                <div class="space-y-4">
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-1.5 text-slate-600">
                            ...
                            <span>{{ $gallery->published_at ? \Carbon\Carbon::parse($gallery->published_at)->locale('id')->isoFormat('D MMMM YYYY') : $gallery->created_at->locale('id')->isoFormat('D MMMM YYYY') }}</span>
                        </div>
                    </div>
                </div>
