...
<div class="bg-slate-50/60 min-h-screen py-10 md:py-16">
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav class="flex items-center gap-2 mb-8 text-xs font-semibold text-slate-500 overflow-x-auto pb-2">
            ...
            <a href="{{ url('/layanan') }}" class="hover:text-orange-600 transition-colors shrink-0">Layanan Publik</a>
            <span class="text-slate-300">/</span>
            ...
            <div class="bg-white rounded-3xl p-6 sm:p-10 border border-slate-200/80 shadow-sm space-y-6">
                <div class="space-y-4">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        <span
                            class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-orange-100 border border-orange-200/80 text-orange-600 text-[8px] font-extrabold uppercase tracking-wider">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-1.5 text-slate-600">
                            ...
                            <span>{{ $service->published_at ? $service->published_at->isoFormat('D MMMM YYYY') : $service->created_at->isoFormat('D MMMM YYYY') }}</span>
                        </div>
                    </div>
                </div>
