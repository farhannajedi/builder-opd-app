            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div
                    ...
                    <div>
                        <!-- Ikon Layanan -->
                        <div
                            class="mb-5 inline-flex p-3.5 bg-brand-50 text-brand-600 border border-brand-100 rounded-2xl group-hover:bg-brand-500 group-hover:text-white group-hover:border-brand-500 transition-colors duration-300 shadow-sm">
                        ...
                        <!-- Nama Layanan -->
                        <h3
                            class="text-base sm:text-lg font-bold text-slate-800 group-hover:text-brand-600 transition-colors leading-snug line-clamp-2 mb-2">
                            {{ $service->name }}
                        </h3>
