        ...
        <div class="bg-white rounded-3xl p-6 sm:p-10 border border-slate-200/80 shadow-sm">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="group h-full">
                    <a href="/pengumuman/{{ $item->slug }}"
                        ...
                        <div
                            class="mt-6 pt-3 border-t border-slate-100 flex items-center justify-between text-slate-400">
                            <div class="flex items-center gap-1.5 text-slate-400">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="h-3.5 w-3.5 text-slate-400 group-hover:text-brand transition-colors"
            ...
            <div class="bg-white border border-slate-200/80 rounded-2xl p-10 text-center shadow-sm">
                <div class="flex flex-col items-center justify-center gap-3">
                    <div class="bg-brand-50 p-3.5 rounded-full border border-brand-100">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-brand-500" fill="none"
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500 mt-1">
                            Saat ini belum ada pengumuman resmi yang diterbitkan oleh
                            {{ $opdName }}.
                        </p>
                    </div>
                </div>
